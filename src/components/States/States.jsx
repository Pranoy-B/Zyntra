...
const States = () => {
    return (
        <div className='bg-purple-600 p-15 space-y-5'>
            ...
            <div className='flex flex-col md:flex md:flex-row md:justify-around justify-center items-center gap-5'>
                ...
                <div className='text-white flex flex-col justify-center items-center space-y-2'>
                    <p>Total Reviews</p>
                    <p className='flex justify-center items-center font-bold text-5xl space-x-3'><span>906k</span><BiLogoPlayStore /></p>
                    <p>46% More Than Last Month</p>
                </div>
                
                <div className='text-white flex flex-col justify-center items-center space-y-2'>
                    <p>Active Apps</p>
                    <p className='flex justify-center items-center font-bold text-4xl space-x-3'><span>132+</span><MdDownload /></p>
